...
from bayes_tom.agents.models.mlp_actor_critic import ActorCritic
from bayes_tom.agents.models.mlp_actor_critic import ActorWithDoubleCritic
from bayes_tom.agents.models.mlp_actor_critic import ActorWithConditionalCritic
from .policy_interface import AgentPolicy
...
class ActorWithConditionalCriticPolicy(AgentPolicy):
    ...
    def get_action(self, params, obs, done, avail_actions, hstate, rng,
        ...
        # print("Pi probs: ", pi.probs.squeeze(0))
        action = jax.lax.cond(test_mode,
                              lambda: pi.mode(),
                              lambda: pi.sample(seed=rng))
